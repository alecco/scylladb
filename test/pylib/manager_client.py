...
class ManagerClient():
    ...
    async def stop(self) -> None:
        """Close driver and stop session"""
        self.driver_close()   # Close after last test case
        await self.cli.stop()
    ...
    # TODO: only pass UUID
    async def remove_node(self, to_remove_ip: str, to_remove_uuid: str) -> None:
        ...
        await self.cli.get_text(f"/cluster/remove-node/{to_remove_ip}/{to_remove_uuid}")
        self._driver_update()
