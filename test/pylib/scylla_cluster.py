...
import time
import uuid
from typing import Optional, Dict, List, Set, Tuple, Callable, AsyncIterator
...
class ScyllaCluster:
    def __init__(self, replicas: int,
        ...
        # last added server to be used as seed for new servers; None if no server is running
