...
# - Create 20+20 tables to alter and 20 tables to index
# - In parallel 20 * create table, and drop/add column and index of previous tables
@pytest.mark.asyncio
@pytest.mark.xfail    # TODO: enable again once raft is enabled (also see suite.yaml)
async def test_cassandra_issue_10250(cql, tables):
    RANGE = 20
    tables_a = []
    tables_i = []
