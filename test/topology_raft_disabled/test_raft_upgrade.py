...
from test.pylib.manager_client import ManagerClient, ServerNum, IPAddress, ServerInfo
...
async def restart(manager: ManagerClient, server_id: ServerNum) -> None:
...
async def enable_raft(manager: ManagerClient, server_id: ServerNum) -> None:
...
async def enable_raft_and_restart(manager: ManagerClient, server_id: ServerNum) -> None:
