...
// Test Raft library for multi datacenter setups
//
// XXX what are these tests for?
//
// DC-A  DC-B, 50% of nodes each
// add delay to cross-DC packets
// randomized server ticker start
//
// partition, isolate leaders...
//
// How to check? not just hangs
//
