...
create_role_statement::execute(query_processor_base&,
...
future<result_message_ptr>
alter_role_statement::execute(query_processor_base&, service::query_state& state, const query_options&) const {
...
future<result_message_ptr>
drop_role_statement::execute(query_processor_base&, service::query_state& state, const query_options&) const {
    auto& as = *state.get_client_state().get_auth_service();
...
future<result_message_ptr>
list_roles_statement::execute(query_processor_base&, service::query_state& state, const query_options&) const {
...
future<result_message_ptr>
grant_role_statement::execute(query_processor_base&, service::query_state& state, const query_options&) const {
    auto& as = *state.get_client_state().get_auth_service();
