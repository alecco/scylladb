...
public:
    ...
    virtual future<::shared_ptr<messages::result_message>> execute(query_processor_base& qp, service::query_state& state, const query_options& options) const override;
private:
