...
class TestCase(NamedTuple):
    ...
    def startswith(self, name: str, case: Optional[str]):
        if self.name.startswith(name) and (not case or self.case.startswith(case)):  # XXX
            print(f"XXX {self.suite_name} {self.name}::{self.case} TestCase.startswith({name}, {case}) {self.name.startswith(name) and (not case or self.case.startswith(case))}") # XXX
        return self.name.startswith(name) and (not case or self.case.startswith(case))
