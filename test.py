...
class PythonTest(Test):
    ...
    def __init__(self, test_no: int, test_def: TestDef, suite) -> None:
        assert test_def.case is None, "PythonTest does not support running specific test cases"
        super().__init__(test_no, test_def, suite)
        self.path = "pytest"
    ...
    def _prepare_pytest_params(self, options: argparse.Namespace):
        ...
        self.args.append(str(self.suite.suite_path / (self.test_def.test_file + ".py")))
...
class TopologyTest(PythonTest):
    ...
    def __init__(self, test_no: int, test_def: TestDef, suite) -> None:
        assert test_def.case is None, "TopologyTest does not support running by test case at the moment"
        super().__init__(test_no, test_def, suite)
