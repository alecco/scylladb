...
fmt::print("\n  {} become_candidate({}) <<<<\n", _my_id, is_prevote? "prevote" : "no prevote"); 
...
fmt::print("  {} become_candidate({}) updating term to {} \n", _my_id, is_prevote? "prevote" : "no prevote", _current_term); 
    }
...
fmt::print("  {} become_candidate(not prevote) WON\n", _my_id);
            become_leader();
        }
    }
}
