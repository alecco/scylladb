...
public:
    ...
    static future<persistent_discovery> make(discovery_peer self, peer_list seeds, cql3::query_processor&);
...
private:
    ...
    persistent_discovery(discovery_peer self, const peer_list&, cql3::query_processor&);
};
